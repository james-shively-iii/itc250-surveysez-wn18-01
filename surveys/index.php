...
date_format(s.DateAdded, '%W %D %M %Y %H:%i') 'DateAdded' from wn18_surveys s, wn18_admins a where s.AdminID=a.AdminID order by s.DateAdded desc
";

#Fills <title> tag. If left empty will default to $PageTitle in config_inc.php  
$config->titleTag = 'Take our surveys!';

#Fills <meta> tags.  Currently we're adding to the existing meta tags in config_inc.php
$config->metaDescription = 'Reedly Coding ITC250 Surveys are made with pure PHP! ' . $config->metaDescription;
$config->metaKeywords = 'Surveys,PHP,Fun,Reedly,Coding,ITC250,'. $config->metaKeywords;
...
# END CONFIG AREA ---------------------------------------------------------- 
#Creator Name, SurveyID, Title, Description
